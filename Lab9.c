...
double find_avg(int *arr, int length) {
  double mean = 0;
...
int find_mode(int *arr, int length) {
  int mode = 0;
  int max = 0;
...
void cal_sick_leaves(int *arr, int length, int *mode, double *avg) {
  // TODO
  //
  *avg = find_avg(arr, length);
  *mode = find_mode(arr, length);
}
